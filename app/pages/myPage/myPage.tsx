      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.categories && Array.isArray(data.categories)) {
            ...
            const fetchedCategories: CategoryData[] = data.categories.slice(0, 4).map((cat: any, index: number) => ({
              id: cat.id,
                        ...
                        <EditingInput
                          ...
                          onBlur={async () => {
                            if (editingIndex !== null) {
                              ...
                              newCategories[editingIndex] = { ...newCategories[editingIndex], name: tempCategoryName };
